# Generated by Django 3.2.19 on 2023-07-15 16:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=255, unique=True, validators=[hubuum.validators.validate_model_can_have_attachments])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_credentials', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jack', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hosts', to='hubuum.jack')),
                ('namespace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hubuum.namespace')),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hosts', to='hubuum.person')),
                ('purchase_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hosts', to='hubuum.purchaseorder')),
                ('room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hosts', to='hubuum.room')),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hosts', to='hubuum.hosttype')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=255, unique=True)),
                ('model', models.CharField(max_length=255, validators=[hubuum.validators.validate_model_can_have_extensions])),
                ('url', models.CharField(max_length=255, validators=[hubuum.validators.validate_url])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynamic_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hubuum.dynamicclass')),
                ('namespace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hubuum.namespace')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('extension', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hubuum.extension')),
                ('namespace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hubuum.namespace')),
            ],
            options={
                'ordering': ['id'],
